                                                ...
                                                <div class='mb-3'>
                                                    ...
                                                    <select class="form-control" name="category[]">   
                                                          ...
                                                          @foreach ($categories as $key => $category)
                                                            <option value="{{ $key }}" {{ ( $key == $products[$i]->id_category) ? 'selected' : '' }}> 
                                                                {{ $category }} 
                                                            </option>
                                                          @endforeach    
                                                    </select>
